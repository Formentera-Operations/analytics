...
renamed as (
    select
        ...
        -- dates
        dttmstart::timestamp_ntz as disposition_start_date,
        dttmend::timestamp_ntz as disposition_end_date,
...
enhanced as (
    select
        {{ dbt_utils.generate_surrogate_key(['id_rec']) }} as monthly_disposition_sk,
        *,
