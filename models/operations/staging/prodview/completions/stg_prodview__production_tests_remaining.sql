...
renamed as (
    select
        ...
        -- test information
        dttmlasttest::timestamp_ntz as last_test_date,
        notestremain::int as required_tests_remaining,
...
enhanced as (
    select
        {{ dbt_utils.generate_surrogate_key(['id_rec']) }} as production_test_remaining_sk,
        *,
