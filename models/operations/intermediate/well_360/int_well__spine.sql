...
all_sources as (
    select eid, api_10, source_system from combo_curve_wells
    union all
    select eid, api_10, source_system from wellview_wells
    union all
    select eid, api_10, source_system from prodview_wells
    union all
    select eid, api_10, source_system from oda_wells
),
